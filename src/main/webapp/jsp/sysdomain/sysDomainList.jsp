								...
								<div id="selectDiv">
									<ul>
										<li class="col-md-6">
											<p class="word">领域名称</p>
											<p>
												<input class="int-text int-medium" id="domainCn" value=""
													type="text">
											</p>
										</li>
										<li class="col-md-6">
											...
											<div class="form-label mt-10">
												...
												<ul>
													<li>
														...
														<p>
															<input type="text" class="int-text int-small"
																id="updateRemarks" name="remarks"> <input
																type="hidden" id="realRemarks">
														</p>
													</li>
												</ul>
												<ul>
													<li>
														...
														<p>
															<input type="text" class="int-text int-small"
																id="updateSort" name="sort"> <input
																type="hidden" id="realSort">
														</p>
													</li>
												</ul>
												<ul>
