define('app/jsp/order/doneOrderList', function (require, exports, module) {
    'use strict';
    var $=require('jquery'),
    ...
    //定义页面组件类
    var DoneOrderListPager = Widget.extend({
    	...
    	//重写父类
    	setup: function () {
    		DoneOrderListPager.superclass.setup.call(this);
    		// 初始化执行搜索
		...
		_searchOrderList:function(){
			var _this=this;
			var url = _base+"/getDoneOrdPageData";
			...
			$("#pagination").runnerPagination({
				...
				data : queryData,
				pageSize: DoneOrderListPager.DEFAULT_PAGE_SIZE,
				visiblePages:5,
				message: "正在为您查询数据..",
    ...
    module.exports = DoneOrderListPager
});
