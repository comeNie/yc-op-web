	                    	...
	                    	<div class="form-label">
		                    	...
		                    	<div id="selectDiv" style="display:none;">
						           ...
						           <div id="lockTimeDiv">
							           	<ul>
							                <li class="col-md-6">
							                    <p class="word">接单开始时间</p>
							                    <p><input name="control_date" readonly class="int-text int-medium " type="text"  id="lockTimeBegin" name="lockTimeBegin"/>
							                   <span class="time"> <i class="fa  fa-calendar" ></i></span>
							                    </p>
							                </li>
							                <li class="col-md-6">
							                    <p class="word">接单结束时间</p>
							                    <p><input name="control_date" readonly class="int-text int-medium " type="text"  id="lockTimeEnd" name="lockTimeEnd"/>
							                     <span class="time"><i class="fa  fa-calendar" ></i></span>
							                    </p>
							                </li> 
							            </ul> 
...
<script id="orderListTemple" type="text/template">
  ...
  <%-- 展示日历 --%>
	...
	var pager;
	(function () {
		seajs.use('app/jsp/order/updatingOrderList', function (UpdatingOrdListPager) {
			pager = new UpdatingOrdListPager({element: document.body});
			pager.render();
		});
	})();
 </script>  
