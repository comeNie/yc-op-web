define('app/jsp/translatorBill/addRechargeWithdrawals', function (require, exports, module) {
    'use strict';
    var $=require('jquery'),
    ...
    var OrderListPager = Widget.extend({
		...
		_initValidate:function(){
	    	...
	    	_closeDialog:function(){
	    		window.location.href = _base+"/rechargeWithdrawals/toRechargeWithdrawals";
	    	}
