						           ...
						           <div id="payTimeDiv">
							           	<ul>
							                <li class="col-md-6">
							                    ...
							                    <p><input  readonly class="int-text int-medium " type="text"  id="payTimeBegin" name="payTimeBegin" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'payTimeEnd\')}'});" />
							                    </p>
							                </li>
							                <li class="col-md-6">
