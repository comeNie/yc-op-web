	                    	...
	                    	<div class="form-label">
		                    	...
		                    	<div id="selectDiv" style="display:none;">
						           ...
						           <div id="updateTimeDiv">
							           	<ul>
							                <li class="col-md-6">
							                    <p class="word">报价开始时间</p>
							                    <p><input  readonly class="int-text int-medium " type="text"  id="updateTimeBegin" name="updateTimeBegin" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'updateTimeEnd\')}'});"/>
							                    </p>
							                </li>
							                <li class="col-md-6">
							                    <p class="word">报价结束时间</p>
							                    <p><input  readonly class="int-text int-medium " type="text"  id="updateTimeEnd" name="updateTimeEnd" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'updateTimeBegin\')}'});"/>
							                    </p>
							                </li> 
							            </ul> 
						           </div>
		                    		...
		                    		<ul>
			                    		<li class="col-md-6">
								            <p class="word">报价人</p>
							            	<p><input class="int-text int-medium" id="updateName" type="text"></p>
							            </li>
			                    	</ul>
		                    	</div> 
	                    		<ul>
...
<script id="orderListTemple" type="text/template">
	<tr>
      ...
      <td>{{:orderLevelPage}}</td>
 	  <td>{{:~timestampToDate('yyyy-MM-dd hh:mm:ss',updateTime)}}</td>
  ...
  <script type="text/javascript">
	var pager;
	(function () {
		seajs.use('app/jsp/order/waitPayOrderList', function (WaitPayOrderListPager) {
			pager = new WaitPayOrderListPager({element: document.body});
			pager.render();
		});
	})();
 </script>  
