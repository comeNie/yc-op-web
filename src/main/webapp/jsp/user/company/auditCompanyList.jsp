			                    	...
			                    	<div id="orderTimeDiv">
			                    		<ul>
							                <li class="col-md-6">
							                    <p class="word">创建时间</p>
							                    <p>
							                    <input  readonly class="int-text int-medium " type="text"  id="createStartTime" name="beginDate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'createStartTime\')}'});" />~
