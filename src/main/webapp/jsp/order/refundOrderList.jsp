							...
							<div class="main-box-body clearfix">
								<div class="order-list-table">
									<ul>
										...
										<li ><a href="#"  id="refundId" >退款列表</a></li>
									</ul>
								</div>
							</div>
                        <!--标题结束-->   
...
<script id="orderListTemple" type="text/template">
  ...
  <script type="text/javascript">
	var pager;
	(function () {
		seajs.use('app/jsp/order/refundOrderList', function (RefundOrderListPager) {
			pager = new RefundOrderListPager({element: document.body});
			pager.render();
		});
	})();
 </script>  
