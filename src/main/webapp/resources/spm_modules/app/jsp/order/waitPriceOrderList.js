define('app/jsp/order/waitPriceOrderList', function (require, exports, module) {
    'use strict';
    var $=require('jquery'),
    ...
    //定义页面组件类
    var WaitPriceOrderListPager = Widget.extend({
    	...
    	//重写父类
    	setup: function () {
    		WaitPriceOrderListPager.superclass.setup.call(this);
    		// 初始化执行搜索
		...
		_searchOrderList:function(){
			var _this=this;
			var url = _base+"/getWaitPriceOrderData";
			...
			$("#pagination").runnerPagination({
				...
				data : queryData,
				pageSize: WaitPriceOrderListPager.DEFAULT_PAGE_SIZE,
				visiblePages:5,
				message: "正在为您查询数据..",
    ...
    module.exports = WaitPriceOrderListPager
});
