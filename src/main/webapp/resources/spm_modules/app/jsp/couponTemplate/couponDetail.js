define('app/jsp/couponTemplate/couponDetail', function (require, exports, module) {
	'use strict';
	var $=require('jquery'),
	...
	var OrderListPager = Widget.extend({
		...
		setup: function () {
			...
			// 初始化执行搜索
			this._searchCouponDetailList();
		},
		
		_searchCouponDetailList:function(){
			var _this=this;
			var url = _base+"/coupon/getCouponDetailData";
			...
			$("#pagination").runnerPagination({
				...
				render: function (data) {
					if(data&&data.length>0){
						var template = $.templates("#couponDetailListTemple");
		...
		_getSearchParams:function(){
			return {
				"templateId":jQuery.trim($("#templateId").val()),
			}
		},
	});
