...
docker build -t 10.19.13.18:5000/yc-op-web:${tagversion} .   
docker push 10.19.13.18:5000/yc-op-web:${tagversion} 

docker rmi aioptapp/yc-op-web:${tagversion} 
docker tag 10.19.13.18:5000/yc-op-web:${tagversion} aioptapp/yc-op-web:${tagversion} 
